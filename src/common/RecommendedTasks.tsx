...
const tasks = [
  'Post on twitter.com with content "An automated post from Better-Fuji 🌋 by @NormalComputing and @H1B0B0! :)" If I\'m not logged in, fail the task and wait for me to log in.',
    ...
    <VStack spacing={2} align="stretch">
      ...
      >
        ...
        <Text fontWeight={400} noOfLines={1} color="gray">
          with content &quot;An automated post from Better-Fuji-Web by
          @NormalComputing!&quot;
        </Text>
      </Button>
      <Button
